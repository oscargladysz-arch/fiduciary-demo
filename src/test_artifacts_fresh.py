...
Compared (normalized: keys named "generated" dropped, CSV by parsed rows): liquidity, facts, cohorts, benchmark selections,
product JSONs and evidence CSVs (engine-owned cells), supplement, citations.
Memos are build output (site/memos/), regenerated by every build.
